...
var DataService = (function () {
    ...
    DataService.prototype.postImgs = function (formData) {
        return this._http.post("/api/uploadImgs", formData);
    };
    DataService.prototype.getDocs = function () {
    ...
    DataService.prototype.delDat = function (path) {
...
// module
exports.push([module.i, "figure i {\r\n    font-size: 150px;\r\n}\r\n\r\n.box span {\r\n    display: block;\r\n}", ""]);
...
var DatotekeFormaComponent = (function () {
    ...
    DatotekeFormaComponent.prototype.imgChangeEvent = function (imgInput) {
        this.imgsToUpload = imgInput.target.files;
        //this.product.photo = fileInput.target.files[0]['name'];
    };
    ...
    DatotekeFormaComponent.prototype.uploadDat = function () {
        ...
        this._dataService.postDat(formData)
            ...
            _this.pullDocs();
        }, function (error) { _this.err = error + ' - ' + 'Greška - prevelika datoteka, previše odabranih datoteka ili nedopušteni format'; setTimeout(function () { _this.err = ''; }, 5000); });
        this.fileInput.nativeElement.value = "";
    };
    DatotekeFormaComponent.prototype.uploadImgs = function () {
        var _this = this;
        var formData = new FormData();
        var files = this.imgsToUpload;
        for (var i = 0; i < files.length; i++) {
            formData.append("uploads[]", files[i], files[i]['name']);
        }
        //console.log('form data variable :   '+ formData.toString());
        this._dataService.postImgs(formData)
            .map(function (files) { return files.json(); })
            .subscribe(function (response) { return console.log('Slike prenesene'); }, function (error) { _this.err = error + ' - ' + 'Greška - prevelika datoteka, previše odabranih datoteka ili nedopušteni format'; setTimeout(function () { _this.err = ''; }, 5000); });
        this.imgInput.nativeElement.value = "";
    };
    DatotekeFormaComponent.prototype.pullDocs = function () {
        var _this = this;
    ...
    DatotekeFormaComponent.prototype.pullImgs = function () {
        var _this = this;
        this._dataService.getImgs()
            .subscribe(function (res) { return _this.savedImgs = res; });
    };
    DatotekeFormaComponent.prototype.detectExt = function (filename) {
        return filename.split('.').pop();
    };
    DatotekeFormaComponent.prototype.setImgByExt = function (doc) {
        var ext = this.detectExt(doc);
        switch (ext) {
            case 'pdf':
    ...
    DatotekeFormaComponent.prototype.checkSelected = function (arr, path) {
    ...
    DatotekeFormaComponent.prototype.addSelectItem = function (arr, path) {
        var res = this.checkSelected(arr, path);
        res ? arr.splice(res - 1, 1) : arr.push(path);
    };
    DatotekeFormaComponent.prototype.delItem = function (path) {
        var _this = this;
...
__decorate([
    ...
    __metadata("design:type", Object)
], DatotekeFormaComponent.prototype, "imgInput", void 0);
...
var SadrzajFormaComponent = (function () {
    ...
    SadrzajFormaComponent.prototype.delSadrzaj = function (br) {
        ...
        this._dataService.deleteSadrzaj(this.sadrzaj[br]._id)
            .subscribe(function (data) {
            _this.trenutniSadrzaj = null;
            _this.pullSadrzaj();
            _this.rollbackSadrzajHidden = false;
        });
    };
    ...
    SadrzajFormaComponent.prototype.addSadrzaj = function () {
        ...
        if (this.addSadrzajForm.valid) {
            ...
            this.newSadrzaj = new __WEBPACK_IMPORTED_MODULE_2__sadrzaj__["a" /* Sadrzaj */](false, 'Vijest', '', '', '');
        }
    };
    SadrzajFormaComponent.prototype.rollbackSadrzaj = function () {
        var _this = this;
        this._dataService.addSadrzaj(this.backupClanak)
            .subscribe(function (data) {
            _this.pullSadrzaj();
            _this.rollbackSadrzajHidden = true;
        });
    };
...
var Sadrzaj = (function () {
    function Sadrzaj(pic, category, author, name, text, img, moreImg) {
    }
    return Sadrzaj;
}());
